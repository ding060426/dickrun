...
assert.doesNotMatch(html, /id="summaryPanel"/);
assert.doesNotMatch(html, /会议处理完成后将生成摘要/);
assert.match(html, /id="llmModelName"[^>]+value="deepseek-v4-flash"/);
assert.match(html, /value="deepseek-v4-pro"/);
assert.match(html, /id="btnRefreshLLMModels"/);
