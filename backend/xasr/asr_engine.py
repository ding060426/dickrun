    ...
    def __init__(
        ...
        if enable_cognitive:
            try:
                ...
                # Auto-enroll from Eval_Ali if available
                enrolled = self.speaker_identifier.enroll_from_eval_ali(eval_ali_root)
                if enrolled > 0:
                    ...
                    logger.info("SpeakerIdentifier: no speakers enrolled (Eval_Ali not found)")
