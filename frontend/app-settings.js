  ...
  function normalizeAppSettings(payload) {
    ...
    return {
      recognition: {
        ...
        live_asr_profile: choice(recognition.live_asr_profile, ASR_PROFILES, 'low-latency'),
        final_asr_profile: choice(recognition.final_asr_profile, ASR_PROFILES, 'low-latency'),
