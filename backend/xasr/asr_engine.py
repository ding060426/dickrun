...
class XASREngine:
    ...
    def _load_audio(self, file_path: str):
        ...
        # MP3 / video containers via pydub. Prefer bundled imageio-ffmpeg when
        # system ffmpeg is not on PATH, which is common on Windows machines.
        try:
            ...
            try:
                ...
                logger.debug(f"imageio-ffmpeg unavailable: {ffmpeg_err}")
